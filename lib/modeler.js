...
async function createModel() {
  ...
  model.add(tf.layers.dense({units: 72, activation: 'linear', inputShape: [config.tensorflow.input_size]}))
...
async function predict() {
  ...
  //print(predictionSadAngry, 'Sad & Angry')
}

function print(prediction, title){
